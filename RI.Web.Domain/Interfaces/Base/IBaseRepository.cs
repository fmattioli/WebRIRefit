...
namespace RI.Web.Domain.Interfaces.Base
{
    public interface IBaseRepository<T> where T : class
    {
        ...
        Task<RetornoAcao<int>> ObterValorInteiro(string Tabela, string Coluna, int Valor);
        Task<RetornoAcao<bool>> ObterValorBooleano(string Tabela, string Coluna, int Valor);
        Task<RetornoAcao> Atualizar(T Entidade);
        Task<RetornoAcao> Inserir(T Entidade);
